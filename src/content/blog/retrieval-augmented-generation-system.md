...
description: A detailed log of 33 experiments building a production RAG system for Korean legal multiple-choice questions, documenting iterative pipeline improvements that lifted accuracy from a 51.58% baseline to 53.67%.
pubDate: 2026-03-30
...
주어진 과제 기간동안 달성한 추론 모델의 최대 성능(dev set 기준)은 `53.67%`로, Baseline `51.58%` 대비 `1.7%`의 향상을 이끌어 냈다.  
...
![accuracy](/assets/img/posts/2026-03-30-retrieval-augmented-generation-system.png)
