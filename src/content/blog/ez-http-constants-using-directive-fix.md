...
description: An open-source contribution to the EZ language that added named HTTP status code constants and fixed the type checker so the 'using' directive correctly brings stdlib constants into scope.
pubDate: 2026-01-02
