...
description: How migrating from GitHub-hosted runners to native ARM64 AWS EC2 self-hosted runners eliminated QEMU emulation overhead and cut average build time from 15 minutes to 4 minutes.
pubDate: 2026-04-27
